...
object T {
    fun s(lang: String, key: String): String {
        ...
        return when (key) {
            ...
            "scan_receipt" -> if (id) "Scan Struk Belanja" else "Scan Receipt"
            "scan_desc" -> if (id) "Foto struk langsung, total otomatis menghitung & foto tidak tersimpan di HP" else "Take photo directly, auto calculates & photo won't clutter gallery"
